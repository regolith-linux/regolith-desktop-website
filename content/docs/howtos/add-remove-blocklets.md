...
**Note**: If any block configuration exists in the user directory `~/.config/regolith2/i3xrocks/conf.d`, then the defaults in `/usr/share/i3xrocks/conf.d/` will be ignored.
