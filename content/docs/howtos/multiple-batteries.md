...
1. [Stage your i3xrocks configuration files]({{< ref "add-remove-blocklets#customize-bar" >}}), then open `~/.config/regolith2/i3xrocks/conf.d/80_battery` in your editor of choice.
