'use strict';(function(){const searchDataURL='/en.search-data.min.b01d63bde243c1276fdbef34f28609eaa75bc8c29cddd95b45182bf13d0676b5.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
